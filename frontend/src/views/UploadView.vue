<template>
  <div class="max-w-2xl mx-auto">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">上传视频</h1>
    ...
    >
      ...
      <div v-else class="space-y-4">
        ...
        <div v-if="uploadResult" :class="uploadResult.success ? 'text-green-600' : 'text-red-600'">
    ...
    <div v-if="uploadedUuid" class="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
      <p class="text-green-700 mb-3">上传成功！视频正在转码中...</p>
      <div class="flex gap-3">
        ...
        <router-link 
          ...
          class="px-4 py-2 border border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition-all"
        >
          查看详情
        </router-link>
      </div>
